<template>
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" :width="dimension" :height="dimension" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve">
        <g>
            <path
                ...
                :fill="props.iconColor" opacity="1" data-original="#000000"></path>
            <path
...
let dimension = ref(30);
onMounted(()=>{
    if(props.dimension != undefined){
        dimension.value=props.dimension;
    }
})
</script>